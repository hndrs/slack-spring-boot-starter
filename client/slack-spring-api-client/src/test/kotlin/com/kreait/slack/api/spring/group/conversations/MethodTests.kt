...
class MethodInvocationTest {
    ...
    private fun testCases() = listOf(
            ...
            MetaInfo("conversations.listGroups", SuccessfulConversationListResponse.sample(), ErrorConversationListResponse.sample(), ConversationsListRequest.sample(), SpringConversationsListMethod("", mockTemplate)),
