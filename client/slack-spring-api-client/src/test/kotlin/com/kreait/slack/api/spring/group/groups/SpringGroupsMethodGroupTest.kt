...
class SpringGroupsMethodGroupTest() {
    ...
    private fun testCases() = listOf(
            MetaInfo("groups.archive", SuccessfulGroupsArchiveResponse.sample(), ErrorGroupsArchiveResponse.sample(), GroupsArchiveRequest.sample(), SpringGroupsArchiveMethod("", mockTemplate)),
            MetaInfo("groups.createChild", SuccessfulGroupsCreateChildResponse.sample(), ErrorGroupsCreateChildResponse.sample(), GroupsCreateChildRequest.sample(), SpringGroupsCreateChildMethod("", mockTemplate)),
            MetaInfo("groups.create", SuccessfulGroupsCreateResponse.sample(), ErrorGroupsCreateResponse.sample(), GroupsCreateRequest, SpringGroupsCreateMethod("", mockTemplate)),
            MetaInfo("groups.history", SuccessfulGroupsHistoryResponse.sample(), ErrorGroupsHistoryResponse.sample(), GroupsHistoryRequest.sample(), SpringGroupsHistoryMethod("", mockTemplate)),
            MetaInfo("groups.info", SuccessfulGroupsInfoResponse.sample(), ErrorGroupsInfoResponse.sample(), GroupsInfoRequest.sample(), SpringGroupsInfoMethod("", mockTemplate)),
            MetaInfo("groups.open", SuccessfulGroupsOpenResponse.sample(), ErrorGroupsOpenResponse.sample(), GroupsOpenRequest.sample(), SpringGroupsOpenMethod("", mockTemplate)),
            ...
            MetaInfo("groups.setPurpose", SuccessfulGroupsSetPurposeResponse.sample(), ErrorGroupsSetPurposeResponse.sample(), GetPresenceRequest.sample(), SpringGroupsSetPurposeMethod("", mockTemplate)),
            MetaInfo("groups.setTopic", SuccessfulGroupsSetTopicResponse.sample(), ErrorGroupsSetTopicResponse.sample(), GroupsSetTopicRequest.sample(), SpringGroupsSetTopicMethod("", mockTemplate)),
            MetaInfo("groups.unarchive", SuccessfulGroupsUnarchiveResponse.sample(), ErrorGroupsUnarchiveResponse.sample(), GroupsUnarchiveRequest.sample(), SpringGroupsUnarchiveMethod("", mockTemplate))
    )
}
