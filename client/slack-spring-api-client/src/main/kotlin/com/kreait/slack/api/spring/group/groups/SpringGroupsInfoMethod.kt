...
/**
 * Spring based implementation of [GroupsMethodGroup.info]
 */
class SpringGroupsInfoMethod(private val authToken: String, private val restTemplate: RestTemplate = RestTemplateFactory.slackTemplate()) : GroupsInfoMethod() {
