...
object DynamicMockGroupTests {
    ...
    private fun test(it: MockMetaInfo) {
        MockMethodTestHelper.verify(it.methodProvider as () -> io.hndrs.slack.api.group.ApiCallMethod<Any, Any, Any, Any>, it.successFunction, it.successResponse, it.failureFunction, it.failureResponse, it.params)
