 ...
 */
class UserJoinedEventReceiver @Autowired constructor(private val userStore: UserStore) : TypedEventReceiver<TeamJoin>(TeamJoin::class.java) {


    override fun onReceiveEvent(slackEvent: SlackEvent, data: TeamJoin, headers: HttpHeaders, team: Team) {
        this.userStore.put(userOfMember(data.member))
    }
}
