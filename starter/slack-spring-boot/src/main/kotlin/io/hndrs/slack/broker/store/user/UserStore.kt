...
fun userOfLocalUser(localUser: FileUserStore.LocalUser): User {
    return User(
        ...
        localUser.realName,
        localUser.timezone,
        localUser.timezoneLabel,
        localUser.timezoneOffset,
        User.UserProfile(
            localUser.profile.title,
            localUser.profile.phone,
            localUser.profile.skype,
            localUser.profile.realName,
            ...
            localUser.profile.image72,
            localUser.profile.image192,
            localUser.profile.image512,
            localUser.profile.image1024,
            localUser.profile.statusTextCanonical,
            localUser.profile.team
        ),
        localUser.isAdmin,
        localUser.isOwner,
        localUser.isPrimaryOwner,
        localUser.isRestricted,
        localUser.isUltraRestricted,
        localUser.isBot,
        localUser.lastModifiedAt,
        localUser.isAppUser,
        localUser.has2fa,
        localUser.locale
    )
