    ...
    data class LocalUser(
            ...
            companion object {
                ...
                fun of(userProfile: User.UserProfile): UserProfile {
                    return UserProfile(
                        ...
                        userProfile.image48,
                        userProfile.image72,
                        userProfile.image192,
                        userProfile.image512,
                        userProfile.image1024,
                        userProfile.statusTextCanonical,
                        userProfile.team
                    )
                }
            }
        ...
        companion object {
            ...
            fun of(user: User): LocalUser {
                return LocalUser(
                    user.id, user.teamId, user.name, user.isDeleted, user.color, user.realName,
