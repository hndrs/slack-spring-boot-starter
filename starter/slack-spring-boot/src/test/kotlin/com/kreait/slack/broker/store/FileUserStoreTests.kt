    ...
    inner class OperationTests {
        ...
        inner class UserChangedEventReceiverTest() {
            ...
            fun testSupport() {
                ...
                Assertions.assertTrue(receiver.supportsEvent(SlackEvent.sample(
                        UserChange.sample().copy(Member.sample().copy(id = "testId"))
                )))
                deleteFile()
            }
            ...
            fun testReceive() {
                ...
                val event = SlackEvent.sample(UserChange.sample().copy(
                        member = member.copy(id = "UserChangedEventReceiverTest", name = "testNew")
                ))
        ...
        inner class UserJoinedEventReceiverTest() {
            ...
            fun testSupport() {
                ...
                Assertions.assertTrue(receiver.supportsEvent(SlackEvent.sample(TeamJoin.sample())))
                deleteFile()
            }
