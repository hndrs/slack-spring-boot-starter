...
Join the discussion on gitter :) image:https://badges.gitter.im/kreait/slack-spring-boot-starter.svg[link="https://gitter.im/kreait/slack-spring-boot-starter?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge"]

Ask questions on stackoverflow image:http://img.shields.io/badge/stackoverflow-slack-informational.svg[link="https://meta.stackoverflow.com/questions/tagged/slack"]
