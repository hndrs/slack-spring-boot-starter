...
We use the MockSlackClient to set the correct response for our testcase, in `testSuccess()` we create a sample-`SuccessfulPostMessageResponse` object with our `.sample()` method as the response.
