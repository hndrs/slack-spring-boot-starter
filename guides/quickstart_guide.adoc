...
[source,groovy]
--
implementation(group: "io.hndrs.slack", name: "slack-spring-boot-starter", version: "current-version", changing: true)

testImplementation(group: "io.hndrs.slack", name: "slack-spring-test-api-client", version: "current-version")

testImplementation(group: "io.hndrs.slack", name: "slack-jackson-dto-test", version: "current-version")
--
