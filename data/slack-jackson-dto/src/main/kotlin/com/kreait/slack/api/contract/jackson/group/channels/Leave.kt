...
@JacksonDataClass
data class SuccessfulChannelsLeaveResponse constructor(override val ok: Boolean) : ChannelsLeaveResponse(ok) {
    companion object
}
 ...
 */
@JacksonDataClass
data class ErrorChannelsLeaveResponse constructor(
