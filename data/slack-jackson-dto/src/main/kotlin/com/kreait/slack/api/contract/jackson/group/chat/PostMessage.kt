 ...
 */
@JacksonDataClass
data class ErrorPostMessageResponse constructor(
    override val ok: Boolean,
 ...
 */
@JacksonDataClass
data class PostMessageRequest constructor(
