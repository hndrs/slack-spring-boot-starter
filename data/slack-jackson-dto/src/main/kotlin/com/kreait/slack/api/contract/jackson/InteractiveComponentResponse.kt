...
data class InteractiveMessage(
    ...
    @JsonProperty("attachment_id") val attachmentId: String? = null
) : InteractiveComponentResponse(Type.INTERACTIVE_MESSAGE, team) {
    companion object
}
...
data class BlockActions(
    ...
    @JsonProperty("channel") val channel: Channel,
    @JsonProperty("response_url") val responseUrl: String?,
    @JsonProperty("actions") val actions: List<Element>? = listOf()
) : InteractiveComponentResponse(Type.BLOCK_ACTIONS, team) {
    companion object
}
