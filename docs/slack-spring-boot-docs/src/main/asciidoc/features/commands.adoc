...
To use https://api.slack.com/slash-commands[Slash Commands] in your app configure the Slash Command in the slack-app like described in the <<../getting-started.adoc#Create a Slash-Command,Getting Started Guide>>.
