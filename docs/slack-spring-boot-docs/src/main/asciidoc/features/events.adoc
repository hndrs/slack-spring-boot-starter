...
To receive slack-events, you have to configure events on your slack-app like described in the <<../getting-started.adoc#Receive Events,Getting Started Guide>>.
