...
--
testImplementation(group: "io.hndrs.slack", name: "slack-jackson-dto-test", version: "{lib-version}")
...
[source,subs="attributes"]
--
testImplementation(group: "io.hndrs.slack", name: "slack-spring-test-api-client", version: "{lib-version}")
--
